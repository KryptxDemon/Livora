    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.welcomeCard}>
          <View style={styles.welcomeRow}>
            ...
            <View style={styles.welcomeInfo}>
              ...
              <Text style={styles.welcomeName}>{employerProfile?.name || 'Employer'}</Text>
            </View>
          </View>
          ...
          <View style={styles.creditsRow}>
            ...
            <Text style={styles.creditsLabel}>{t('smsCredits')}:</Text>
            <Text style={styles.creditsValue}>{employerProfile?.smsCredits || 0}</Text>
          </View>
        </View>
        ...
        <View style={styles.actionsGrid}>
          ...
          <TouchableOpacity 
            style={styles.actionCard}
            onPress={() => router.push('/employer/package-select')}
          >
            <View style={[styles.actionIcon, { backgroundColor: '#FFF3E0' }]}>
              <Ionicons name="pricetag-outline" size={28} color="#EF6C00" />
            </View>
            <Text style={styles.actionText}>{t('selectPackage')}</Text>
          </TouchableOpacity>
